...
export function StickyHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-2.5 md:px-8 md:py-3 bg-[#1A4D4D]/90 backdrop-blur-md shadow-lg shadow-black/10">
      ...
      <nav aria-label="Связаться с нами" className="flex items-center gap-2.5 md:gap-3">
        {/* Позвонить */}
        <a
          href="tel:+78622000000"
          aria-label="Позвонить"
          className="flex h-9 w-9 md:h-10 md:w-10 items-center justify-center rounded-full bg-white/15 transition-colors hover:bg-[#F4C430]/30"
        >
          <svg viewBox="0 0 24 24" className="h-4.5 w-4.5 md:h-5 md:w-5 fill-[#F5EDD6]">
